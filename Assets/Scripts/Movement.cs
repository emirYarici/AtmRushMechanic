...
public class Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            firstCube.transform.position -= Vector3.forward * forwardMoveSpeed * Time.deltaTime;//regular go forward
        }
    ...
    {
        Vector3 pos = firstCube.transform.position;
        pos.z += 30;
        firstCube.transform.position = pos;
        stopForwardMovement = false;
        Collect.Instance.EmptyStackSpread();
        //firstCube.transform.DOLocalMoveZ(firstCube.transform.position.z + 30, 2f).OnComplete(()=> stopForwardMovement = false);
